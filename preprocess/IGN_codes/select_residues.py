...
def generate_complex(protein_file, ligand_file):
    ...
    # filecontent += "runCommand('select #1 & #0 z < 5') \n"
    ...
    try:
        ...
        # pocket = Chem.MolFromPDBFile(pocket_file, proximityBonding=False)
        # pocket = Chem.MolFromPDBFile(pocket_file, sanitize=False)
